...
_DEFAULT_PEN_COLOR = lib.color.BLACK
...
def setCanvasSize(w=_DEFAULT_CANVAS_SIZE, h=_DEFAULT_CANVAS_SIZE):
    ...
    pygame.display.set_caption('Delivery Tracking')
...
def hide():
    ...
    _background = pygame.display.set_mode([_canvasWidth, _canvasHeight], flags=pygame.HIDDEN)
...
def unhide():
    ...
    _background = pygame.display.set_mode([_canvasWidth, _canvasHeight], flags=pygame.SHOWN)
